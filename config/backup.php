...
return [
    ...
    'backup' => [
        ...
        * If set to true, the backup will only include modified files since the last backup.
        */
        'incremental' => [
            'include_non_timestamp_tables' => env('BACKUP_INCLUDE_NON_TIMESTAMP_TABLES', false),
            'excluded_tables' => ['migrations', 'cache', 'sessions', 'password_resets', 'failed_jobs'], // Tables to always exclude
        ],
    ...
    'notifications' => [
        ...
        'mail' => [
            ...
            'subject' => env('APP_NAME', 'laravel-backup') . ' backup notification',
