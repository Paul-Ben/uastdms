                        ...
                        <form method="POST" action="{{ route('user.update', $user) }}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-xl-6 mb-3">
                                    ...
                                    <input type="text" value="{{ $user_details->userDetail->nin_number }}"
                                        name="nin_number" class="form-control">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12 col-xl-6 mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Phone</label>
                                    <input type="text" value="{{ $user_details->userDetail->phone_number }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-xl-6 mb-3">
                                    ...
                                    <select id="designationSelect" name="designation" class="form-select">
                                        <option value="{{ $user_details->userDetail->designation }}">
                                            {{ $user_details->userDetail->designation }}</option>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xl-6 mb-3">
                                    ...
                                    <input type="text" value="{{ $user_details->userDetail->tenant->name }}"
                                        class="form-control" readonly>
                                    <input type="text" value="{{ $user_details->userDetail->tenant->id }}"
                                        name="tenant_id" class="form-control" hidden>

                                </div>
                                <div class="col-sm-12 col-xl-6 mb-3">
                                    <label for="departmentSelect" class="form-label">Department</label>
                                    <select id="departmentSelect" name="department_id" class="form-select">
                                        <option value="{{ $user_details->userDetail->department_id }}">
                                            {{ $user->userDetail->tenant_department->name ?? 'No department for this user' }}
                                        </option>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xl-6 mb-3">
                                    ...
                                    <select id="genderSelect" name="gender" class="form-select">
                                        <option value="{{ $user_details->userDetail->gender }}">
                                            {{ $user_details->userDetail->gender }}</option>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xl-6 mb-3">
                                    <label for="exampleInputEmail1"
                                        class="form-label
                                        ">PSN</label>
                                    <input type="text" name="psn" value="{{ $user_details->userDetail->psn }}"
                                        class="form-control" placeholder="PSN">
                                </div>
                                <div class="col-sm-12 col-xl-6 mb-3">
                                    <label for="exampleInputEmail1"
                                        class="form-label
                                    ...
                                    <input type="text" name="grade_level"
                                        value="{{ $user_details->userDetail->grade_level }}" class="form-control"
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xl-6 mb-3">
                                    <label for="exampleInputEmail1"
                                        class="form-label
                                        ">Rank</label>
                                    <input type="text" name="rank" value="{{ $user_details->userDetail->rank }}"
                                ...
                                <div class="col-sm-12 col-xl-6 mb-3">
                                    ...
                                    <input type="text" name="schedule"
                                        value="{{ $user_details->userDetail->schedule }}" class="form-control"
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xl-6 mb-3">
                                    ...
                                    <input type="date" name="employment_date"
                                        value="{{ $user_details->userDetail->employment_date }}" class="form-control"
                                ...
                                <div class="col-sm-12 col-xl-6 mb-3">
                                    ...
                                    <input type="date" name="date_of_birth"
                                        value="{{ $user_details->userDetail->date_of_birth }}" class="form-control"
                                        placeholder="dd/mm/yyyy">
                                </div>
                            </div>
