    ...
    <div class="row ">
        <div class="col-md-8 mx-auto ">
            <div class="contact-form mtop-small-150">
                ...
                <div class="text-center"><img src="{{ asset('landing/images/uastLogo.jpeg') }}" width="100" height="100" alt="benue_logo"></div>
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="row">
                        ...
                        <!-- NIN Field Container with id -->
                        <div class="col-md-6 col-12" id="ninField">
                            <div class="form-floating mb-3">
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-floating mb-4">
                                <select class="form-control" name="account_type" id="accountTypeSelect"
                                    ...
                                    <option value="individual" @if(old('account_type')=='individual') selected @endif>Individual</option>
                                    <option value="corporate" @if(old('account_type')=='corporate') selected @endif>Corporate</option>
                                </select>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-floating mb-4">
                                <select class="form-control" name="region" id="regionSelect"
                                    ...
                                    <option value="nigeria" @if(old('region')=='nigeria') selected @endif>Nigeria</option>
                                    <option value="international" @if(old('region')=='international') selected @endif>International</option>
                                </select>
...
<script>
    ...
    // Toggle region sections and NIN visibility/required
    function toggleRegionFields() {
        ...
        const ninInput = document.getElementById('floatingNIN');
    ...
    // Call toggle functions on page load to respect old values (e.g., on validation errors)
